...
internal sealed class InlineBodyReturnRewriter : LuaSyntaxRewriter
{
    public static SyntaxNode Rewrite(SyntaxNode node, List<string> returnVariableNames)
    {
        InlineBodyReturnRewriter rewriter = new(returnVariableNames);
        return rewriter.Visit(node);
    }

    private readonly List<string> _returnVariableNames;

    private InlineBodyReturnRewriter(List<string> returnVariableNames)
    {
